...
public class StringValueOfTest {
	...
	public static void main(String[] args) {
		...
		/**
		 * utiliza uma parte do array de caracteres charArray para criar um novo
		 * objeto String . O segundo argumento especifica o índice inicial a
		 * partir do qual os caracteres são utilizados. O terceiro argumento
